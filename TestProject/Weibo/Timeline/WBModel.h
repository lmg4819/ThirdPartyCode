...
/**
 一个图片的元数据
 */
@interface WBPictureMetadata : NSObject<YYModel>
...
/**
 图片
 */
@interface WBPicture : NSObject<YYModel>
...
/**
 链接
 */
@interface WBURL : NSObject<YYModel>
...
/**
 话题
 */
@interface WBTopic : NSObject<YYModel>
...
/**
 标签
 */
@interface WBTag : NSObject<YYModel>
...
/**
 按钮
 */
@interface WBButtonLink : NSObject<YYModel>
...
/**
 ...
 -----------------------------
 */
@interface WBPageInfo : NSObject<YYModel>
...
/**
 微博标题
 */
@interface WBStatusTitle : NSObject<YYModel>
...
/**
 用户
 */
@interface WBUser : NSObject<YYModel>
...
/**
 微博
 */
@interface WBStatus : NSObject<YYModel,NSCoding>
...
/**
 一次API请求的数据
 */
@interface WBTimelineItem : NSObject<YYModel>
...
@interface WBEmoticon : NSObject<YYModel>
...
@interface WBEmoticonGroup : NSObject<YYModel>
