...
/**
 The YTKRequestDelegate protocol defines several optional methods you can use to
 receive network-related messages. All the delaget methods will be called on the
 main queue.
 */
...
//If `resumableDownloadPath` and DownloadTask is using, this value will
...
//Called on background thread after request succeded but before switching to main thread. Note if cache is loaded, this method WILL be called on the main thread, just like `requestCompleteFilter`.
...
/**
 Use this to build custom request. If this method return non-nil value,
 `requestUrl`,
 `requestTimeoutInterval`,
 `requestArgument`,
 `allowsCellularAccess`,
 `requestMethod` and
 `requestSerializerType` will all be ignored.
 */
