...
-(instancetype)initWithBaseURL:(NSURL *)url sessionConfiguration:(NSURLSessionConfiguration *)configuration
{
    ...
    if (self) {
        // 如果baseURL不为空，并且结尾不包含“/”，则在baseURL结尾拼上一个空字符串，作用是保证baseURL以“/”结尾
...
-(NSURLSessionDataTask *)HEAD:(NSString *)URLString parameters:(id)parameters success:(void (^)(NSURLSessionDataTask * _Nonnull))success failure:(void (^)(NSURLSessionDataTask * _Nullable, NSError * _Nonnull))failure
{
