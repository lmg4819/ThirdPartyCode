...
{
    [[self allTargets] enumerateObjectsUsingBlock:^(id  _Nonnull object, BOOL * _Nonnull stop) {
...
-(void)addBlockForControlEvents:(UIControlEvents)controlEvents block:(void (^)(id _Nonnull))block
{
    ...
    _YYUIControlBlockTarget *target = [[_YYUIControlBlockTarget alloc]initWithBlock:block events:controlEvents];
